...
- The most consequential change: Vermont's legal definition of "parcel" is splitting in two — an **ownership/billing parcel** (who pays one tax bill) and a **mapping/sellable-lot parcel** (a physical, separately-sellable piece of land) — and today's software mostly only models the first one well.
