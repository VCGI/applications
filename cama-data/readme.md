...
Who owns which lands where? With what details? For several reasons these seemingly simple questions remain not easy to answer throughout Vermont. Many challenges in answering them are due to Vermont's history as a New England State with:
...
- hundreds of small municipalities being responsible for authoritative [land records management](https://vmcta.org/Vermont_Land_Records_Online),
...
- widely varying technology orientations and resulting practices in a low and aged-population state.
