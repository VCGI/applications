...
| OQ-60 | For towns using NEMRC's own separate Land Records (LR) product (confirmed to exist as a distinct module, [§1.3](SPAN_PARCEL_GRANDLIST_MODEL.md#13-nemrcs-broader-municipal-software-footprint)), does deed/transfer data actually originate there and flow LR → Grand List → CAMA, or is sale/transfer data entered independently at the Grand List level regardless of which land-records vendor a town uses? | NEMRC | [SPAN_PARCEL_GRANDLIST_MODEL.md §1.3](SPAN_PARCEL_GRANDLIST_MODEL.md#13-nemrcs-broader-municipal-software-footprint) |
...
| OQ-54 | What "state payments" data does NEMRC's Grand List module store, that NEMRC's own training material flags as confidential (alongside 911 addresses) and unsuitable for a public-facing tax map — a distinct, not-yet-investigated category from anything else documented so far? **A plausible lead, not a confirmed answer:** the Grand List module's own main menu has a dedicated "Homestead Payments" item (distinct from "Homestead Declarations"), a strong candidate for what this refers to. | Tax Dept/PVR, NEMRC | [SPAN_PARCEL_GRANDLIST_MODEL.md §1.6](SPAN_PARCEL_GRANDLIST_MODEL.md#16-town-optional-local-tax-map-integration-out-of-scope-for-the-statewide-pipeline-but-worth-a-few-cross-confirmations); [§1.5](SPAN_PARCEL_GRANDLIST_MODEL.md#15-the-grand-list-modules-own-parcelcontiguous-parcel-ui) |
...
| OQ-58 | The Grand List module is confirmed to maintain frozen, per-year "Billed" snapshot entities (e.g. "Anytown 2016 Billed"), not just prior-value fields on the live record — are these queryable/exportable on demand? If so, could a specific past year's frozen entity be a cleaner source for matching Grand List data to a specific vintage of parcel geometry than reconstructing it from the live entity (relevant to OQ-50/OQ-28's timing-mismatch discussion)? | NEMRC | [SPAN_PARCEL_GRANDLIST_MODEL.md §1.5](SPAN_PARCEL_GRANDLIST_MODEL.md#15-the-grand-list-modules-own-parcelcontiguous-parcel-ui) |
| OQ-59 | Does the Grand List module's own "State Sales Study" menu item feed data into VTPIE's documented "Sales Ratio and Equalization Study" function, duplicate it, or serve an entirely separate purpose? | Tax Dept/PVR, NEMRC | [SPAN_PARCEL_GRANDLIST_MODEL.md §1.2](SPAN_PARCEL_GRANDLIST_MODEL.md#12-vtpie-in-detail); [§1.5](SPAN_PARCEL_GRANDLIST_MODEL.md#15-the-grand-list-modules-own-parcelcontiguous-parcel-ui) |
...
OQ-2, OQ-5, OQ-6, OQ-7, OQ-8, OQ-9 *(confirm/compare)*, OQ-10, OQ-11, OQ-12 *(joint)*, OQ-13, OQ-14, OQ-16 *(joint)*, OQ-18 *(joint)*, OQ-33 *(joint)*, OQ-34, OQ-37 *(joint)*, OQ-38, OQ-49 *(joint)*, OQ-53, OQ-54 *(joint)*, OQ-58, OQ-59 *(joint)*, OQ-60

### NEMRC (as MSOL CAMA vendor)
OQ-1, OQ-2 *(shared with above)*, OQ-22, OQ-51, OQ-52, OQ-57

### Tax Department / PVR
OQ-12, OQ-16, OQ-23, OQ-24, OQ-25, OQ-31, OQ-32, OQ-35, OQ-36, OQ-37, OQ-39, OQ-40, OQ-41, OQ-42, OQ-43, OQ-44, OQ-45, OQ-46, OQ-47, OQ-49, OQ-54 *(joint)*, OQ-55 *(joint)*, OQ-56, OQ-59 *(joint)*
